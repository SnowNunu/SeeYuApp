...
# 【配置上传到蒲公英相关信息】(可选)
__PGYER_U_KEY="142fd86ec8cea3527e3be6c7ebf745ae"
__PGYER_API_KEY="c7f0af23f34c0398e91df5ef90a6633d"

# 【配置上传到 Fir】(可选)
__FIR_API_TOKEN="xKKdjdldlodeikK626266skdkkddK"

# 【配置证书】(如果只有一个证书时该项 可选)
__CODE_SIGN_DISTRIBUTION="iPhone Distribution: Beijing KMX Co.,Ltd. (SRLXHCX26Y)"
__CODE_SIGN_DEVELOPMENT="iPhone Developer: Xiaoguang Xu (J6CPQTNX3U)"

# 发布APP Store 账号密码
__IOS_SUBMIT_ACCOUNT="trc19930224@aliyun.com"
__IOS_SUBMIT_PASSWORD="Trc199324"
...
# 1. 请选择 SCHEME
__SELECT_TARGET_OPTIONS=("1.SeeYu")
...
if [[ $__IS_WORKSPACE_OPTION -eq 1 ]]; then
  ...
  if [[ ${__BUILD_CONFIGURATION} == "Debug" ]]; then
    # step 1. Clean
    # printMessage "开始clean:${__SCHEME_NAME}"
