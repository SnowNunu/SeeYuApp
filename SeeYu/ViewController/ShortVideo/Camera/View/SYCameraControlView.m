...
#import "SYCameraControlView.h"


@interface SYCameraControlView ()

/// previewView
@property (nonatomic , readwrite , strong) SYVideoPreviewView *previewView;
...
@implementation SYCameraControlView
...
- (void)_setupSubViews
{
    ...
    /// 预览层
    SYVideoPreviewView *previewView = [[SYVideoPreviewView alloc] initWithFrame:SY_SCREEN_BOUNDS];
    ...
    [swapBtn setBackgroundImage:SYImageNamed(@"voip_flip_camera_icons_60x60") forState:UIControlStateNormal];
    ...
    swapBtn.tag = SYCameraControlViewOperationTypeSwap;
    
    
    /// 关闭按钮
    UIButton *closeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [closeBtn setImage:SYImageNamed(@"icon_sight_close_40x40") forState:UIControlStateNormal];
    [closeBtn addTarget:self action:@selector(_btnDidClicked:) forControlEvents:UIControlEventTouchUpInside];
    self.closeBtn = closeBtn;
    [self addSubview:closeBtn];
    closeBtn.tag = SYCameraControlViewOperationTypeClose;
    ...
    [cancelBtn setBackgroundImage:SYImageNamed(@"sight_preview_cancel_75x75") forState:UIControlStateNormal];
    ...
    cancelBtn.tag = SYCameraControlViewOperationTypeCancel;
    ...
    [editBtn setBackgroundImage:SYImageNamed(@"EditVideoCameraIconEdit_75x75") forState:UIControlStateNormal];
    ...
    editBtn.tag = SYCameraControlViewOperationTypeEdit;
    
    /// 完成按钮
    UIButton *doneBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [doneBtn setBackgroundImage:SYImageNamed(@"sight_preview_done_75x75") forState:UIControlStateNormal];
    ...
    doneBtn.tag = SYCameraControlViewOperationTypeDone;
