...
@interface SYCameraViewController ()<PKShortVideoRecorderDelegate,SYCameraControlViewDelegate>

/// controlView
@property (nonatomic , readwrite , weak) SYCameraControlView *controlView;
...
- (void)viewDidLoad {
    ...
    [self.preImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(SY_SCREEN_WIDTH);
...
#pragma mark - SYCameraControlViewDelegate
- (void)cameraControlViewOperationAction:(SYCameraControlView *)controlView operationType:(SYCameraControlViewOperationType)operationType{
    switch (operationType) {
        case SYCameraControlViewOperationTypeSwap:
        {
            //
        }
            break;
        case SYCameraControlViewOperationTypeClose:
        {
            [self _closeCamera];
        }
            break;
        case SYCameraControlViewOperationTypeEdit:
        {
            // 编辑
            [self _editSource];
        }
...
- (void)_setupSubViews{
    ...
    // controlView
    SYCameraControlView *controlView = [[SYCameraControlView alloc] initWithFrame:SY_SCREEN_BOUNDS];
