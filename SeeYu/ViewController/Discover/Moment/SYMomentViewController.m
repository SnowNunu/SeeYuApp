...
#import "SYMomentViewController.h"
...
@interface SYMomentViewController ()
/// viewModel
@property (nonatomic, readonly, strong) SYMomentViewModel *viewModel;
/// tableHeaderView
...
@implementation SYMomentViewController
@dynamic viewModel;
