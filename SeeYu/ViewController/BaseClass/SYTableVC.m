...
@interface SYTableVC ()
/// tableView
@property (nonatomic, readwrite, weak)   SYTableView *tableView;
...
- (void)_su_setupSubViews{
    ...
    SYTableView *tableView = [[SYTableView alloc] initWithFrame:[UIScreen mainScreen].bounds style:self.viewModel.style];
    tableView.backgroundColor = SY_MAIN_BACKGROUNDCOLOR;
