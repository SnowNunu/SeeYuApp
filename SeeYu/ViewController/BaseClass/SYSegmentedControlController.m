//
//  SYSegmentedControlController.m
//  WeChat
//
...
#import "SYSegmentedControlController.h"

@interface SYSegmentedControlController ()
...
@implementation SYSegmentedControlController
...
static void *SYSegmentedControlItemKey = &SYSegmentedControlItemKey;

@implementation UIViewController (SYSegmentedControlItem)

- (NSString *)segmentedControlItem {
    return objc_getAssociatedObject(self, SYSegmentedControlItemKey);
}

- (void)setSegmentedControlItem:(NSString *)segmentedControlItem {
    objc_setAssociatedObject(self, SYSegmentedControlItemKey, segmentedControlItem, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
