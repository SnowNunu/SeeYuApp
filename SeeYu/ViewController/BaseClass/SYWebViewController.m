...
/// viewModel
@property (nonatomic, strong, readonly) SYWebViewModel *viewModel;
...
- (void)viewDidLoad {
    ...
    WKWebView *webView = [[WKWebView alloc] initWithFrame:SY_SCREEN_BOUNDS configuration:configuration];
