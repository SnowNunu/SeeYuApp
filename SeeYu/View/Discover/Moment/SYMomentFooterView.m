...
@interface SYMomentFooterView ()
/// 分割线
@property (nonatomic, readwrite, weak) UIImageView *divider;
@end

@implementation SYMomentFooterView

+ (instancetype)footerViewWithTableView:(UITableView *)tableView{
    static NSString *ID = @"MomentFooter";
    SYMomentFooterView *footer = [tableView dequeueReusableHeaderFooterViewWithIdentifier:ID];
    if (footer == nil) {
        // 缓存池中没有, 自己创建
