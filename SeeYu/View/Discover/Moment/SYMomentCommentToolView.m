...
#pragma mark - 初始化
- (void)_setup{
    self.backgroundColor = SYColorFromHexString(@"#FAFAFA");
...
- (void)_setupSubViews{
    ...
    [emoticonBtn setBackgroundImage:SYImageNamed(@"Album_ToolViewEmotion_30x30") forState:UIControlStateNormal];
    [emoticonBtn setBackgroundImage:SYImageNamed(@"Album_ToolViewEmotionHL_30x30") forState:UIControlStateHighlighted];
