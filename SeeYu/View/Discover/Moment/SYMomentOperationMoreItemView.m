//
//  SYMomentOperationMoreItemView.m
//  SYDevelopExample
//
...
@interface SYMomentOperationMoreItemView ()
/// 动画图片
@property (nonatomic, readwrite, weak) UIImageView *animView;

@end

@implementation SYMomentOperationMoreItemView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        /// 设置文字大小
        self.titleLabel.font = SYRegularFont_14;
        /// 设置title内边距
