...
@interface SYProfileInfoMoreCell ()
/// 箭头
...
@implementation SYProfileInfoMoreCell

+ (instancetype)cellWithTableView:(UITableView *)tableView{
    static NSString *ID = @"ProfileInfoMoreCell";
    SYProfileInfoMoreCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
