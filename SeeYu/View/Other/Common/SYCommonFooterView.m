...
@implementation SYCommonFooterView
#pragma mark - 公共方法
+ (instancetype)footerViewWithTableView:(UITableView *)tableView{
    static NSString *ID = @"CommonFooter";
    SYCommonFooterView *footer = [tableView dequeueReusableHeaderFooterViewWithIdentifier:ID];
    if (footer == nil) {
        // 缓存池中没有, 自己创建
...
- (void)_setup{
    ///
    self.contentView.backgroundColor = SY_MAIN_BACKGROUNDCOLOR;
...
- (void)_setupSubViews{
    ...
    contentLabel.textColor = SYColorFromHexString(@"#888888");
    contentLabel.font = SYRegularFont_14;
