...
@interface SYObject : NSObject <YYModel,NSCopying,NSCoding>
...
// properties without ivars, or properties on SYObject itself.
...
// Implements validation logic for SYObject.
@interface SYObject (Validation)
