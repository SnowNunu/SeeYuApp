...
typedef enum {
     ...
     */
    sy_propertyMemoryManagementPolicyAssign = 0,
    
    /**
     * The value is retained.
     */
    sy_propertyMemoryManagementPolicyRetain,
    
    /**
     * The value is copied.
     */
    sy_propertyMemoryManagementPolicyCopy
} sy_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #sy_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    sy_propertyMemoryManagementPolicy memoryManagementPolicy;
