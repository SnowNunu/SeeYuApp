//
//  SYMomentReplyItemViewModel.h
//  WeChat
//
//  Created by senba on 2018/1/24.
//  Copyright © 2018年 CoderMikeHe. All rights reserved.
//  点击评论 或者点击 评论Cell ,通过 Router 模式生成一个 SYMomentReplyItemViewModel 用于 commentToolView的绑定

#import <Foundation/Foundation.h>

@interface SYMomentReplyItemViewModel : NSObject
...
/// 回复:xxx （目标）
@property (nonatomic, readonly, strong) SYUser *toUser;
/** 是否是 回复:xxx （目标） */
...
//// 初始化 （Router）
/// - itemViewModel : `SYMomentItemViewModel` 或者 `SYMomentCommentItemViewModel`
