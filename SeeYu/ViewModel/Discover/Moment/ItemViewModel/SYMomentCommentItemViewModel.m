//
//  SYMomentCommentItemViewModel.m
//  SYDevelopExample
//
...
@interface SYMomentCommentItemViewModel ()

/// 评论模型
@property (nonatomic, readwrite, strong) SYComment *comment;

@end

@implementation SYMomentCommentItemViewModel
...
- (instancetype)initWithComment:(SYComment *)comment
{
    if (self = [super init]) {
        ...
        self.type = SYMomentContentTypeComment;
        ...
        textAttr.yy_font = SYMomentCommentContentFont;
...
//        fromAttr.yy_color = SYMomentScreenNameTextColor;
//        fromAttr.yy_font = SYMomentCommentScreenNameFont;
//        /// 点击高亮
//        YYTextHighlight *fromHighlight = [YYTextHighlight new];
//        // 将用户数据带出去
//        fromHighlight.userInfo = @{SYMomentUserInfoKey:comment.fromUser};
...
//            /// 将用户数据带出去
//            toHighlight.userInfo = @{SYMomentUserInfoKey:comment.toUser};
...
//        contentAttr.yy_alignment = NSTextAlignmentLeft;
        ...
        /// 匹配正则 表情+电话+url...
        [contentAttr sy_regexContentWithWithEmojiImageFontSize:14];
        ...
        self.contentLableFrame = CGRectMake(SYMomentCommentViewContentLeftOrRightInset, SYMomentCommentViewContentTopOrBottomInset, contentLableW, contentLableH);
        self.cellHeight = CGRectGetMaxY(self.contentLableFrame)+SYMomentCommentViewContentTopOrBottomInset;
    }
