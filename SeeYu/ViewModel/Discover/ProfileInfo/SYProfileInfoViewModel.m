...
@interface SYProfileInfoViewModel ()
/// user
...
@implementation SYProfileInfoViewModel
- (instancetype)initWithServices:(id<SYViewModelServices>)services params:(NSDictionary *)params{
    if(self = [super initWithServices:services params:params]){
        self.user = params[SYViewModelUtilKey];
...
- (void)initialize{
    ...
    /// 随机生成图片
    NSInteger count = [NSObject sy_randomNumberWithFrom:0 to:4];
