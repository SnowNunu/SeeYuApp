...
- (void)initialize {
    ...
    self.requestVipPriceInfoCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {
    ...
    [self.requestVipPriceInfoCommand.executionSignals.switchToLatest.deliverOnMainThread subscribeNext:^(NSArray *array) {
        self.datasource = array;
    }];
    [self.requestVipPriceInfoCommand.errors subscribeNext:^(NSError *error) {
