...
- (void)viewDidLoad {
    ...
    SYImageNamed(@"IDMPhotoBrowser.bundle/images/IDMPhotoBrowser_arrowLeft.png")          : _leftArrowImage;

    UIImage *rightButtonImage = (_rightArrowImage == nil) ?
    SYImageNamed(@"IDMPhotoBrowser.bundle/images/IDMPhotoBrowser_arrowRight.png")         : _rightArrowImage;

    UIImage *leftButtonSelectedImage = (_leftArrowSelectedImage == nil) ?
    SYImageNamed(@"IDMPhotoBrowser.bundle/images/IDMPhotoBrowser_arrowLeftSelected.png")  : _leftArrowSelectedImage;

    UIImage *rightButtonSelectedImage = (_rightArrowSelectedImage == nil) ?
    SYImageNamed(@"IDMPhotoBrowser.bundle/images/IDMPhotoBrowser_arrowRightSelected.png") : _rightArrowSelectedImage;
